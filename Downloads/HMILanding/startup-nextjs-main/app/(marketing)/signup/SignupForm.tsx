...
export default function SignupForm() {
  ...
  const [formData, setFormData] = useState({ name: "", email: "", password: "", acceptTerms: false });
  ...
  const validate = (): FormErrors => {
    ...
    if (!formData.acceptTerms) newErrors.acceptTerms = "You must agree to Terms and Conditions";
    return newErrors;
  };
  ...
  const handleGoogleSignIn = async () => {
    console.log('sign In called with google')
    setLoading(true);
          ...
          <div className="w-full px-4">
            <div className="shadow-three mx-auto max-w-[500px] rounded bg-white px-6 py-10 dark:bg-dark sm:p-[60px]">
              ...
              <button
                ...
                disabled={loading}
                className="border-stroke dark:text-body-color-dark dark:shadow-two mb-6 flex w-full cursor-pointer items-center justify-center rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none transition-all duration-300 hover:border-primary hover:bg-primary/5 hover:text-primary disabled:opacity-50"
              >
                <span className="mr-3">
                  {/* Google SVG Icon */}
                  <svg
              ...
              {errors.general && (
                <p className="mb-4 text-center text-sm text-red-500">{errors.general}</p>
              )}
              {successMessage && (
              ...
              <form onSubmit={handleSubmit} noValidate>
                {/* Full Name */}
                <div className="mb-4">
                  <label htmlFor="name" className="mb-2 block text-sm text-dark dark:text-white">
                    Full Name
                  </label>
                  <input
                    id="name"
                ...
                {errors.acceptTerms && <p className="mb-4 text-sm text-red-500">{errors.acceptTerms}</p>}
